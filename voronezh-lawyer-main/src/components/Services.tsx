      ...
      <div className="container mx-auto px-4 md:px-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          ...
          <div className="bg-[#774936] rounded-xl p-4 md:p-6 text-white flex flex-col h-full">
            ...
            <Link href="/services" className="mt-auto py-2 px-4 md:px-6 bg-white/20 hover:bg-white/30 rounded-full text-center text-xs md:text-sm font-medium">
              Подробнее
            </Link>
          </div>
        ...
        <div className="mt-10 md:mt-16 bg-[#e8e3e0] rounded-xl p-5 md:p-8">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="flex justify-center space-x-3 md:space-x-4">
              <Link href="tel:+79081328866" className="bg-white p-3 rounded-full hover:bg-gray-100 inline-block text-2xl">
                📞
              </Link>
              <Link href="mailto:ripinsky@list.ru" className="bg-white p-3 rounded-full hover:bg-gray-100 inline-block text-2xl">
                ✉️
              </Link>
              <Link href="https://wa.me/79081328866" className="bg-white p-3 rounded-full hover:bg-gray-100 inline-block text-2xl">
                💬
              </Link>
              <Link href="https://t.me/+79081328866" className="bg-white p-3 rounded-full hover:bg-gray-100 inline-block text-2xl">
                ✈️
              </Link>
            </div>
          </div>
